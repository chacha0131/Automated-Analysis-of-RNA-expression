...
path = "/Users/emilycha/Desktop/imgs_bagot/PVT/out/quant/"
...
# Group the data by file, type, and count the cells in each group
counts = all_data.groupby(['file', 'type']).apply(lambda x: pd.Series({
